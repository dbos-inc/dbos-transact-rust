-- Migration 29: Create a partial index on workflow_status restricted to
...
CREATE INDEX {{concurrently}} IF NOT EXISTS "idx_workflow_status_pending" ON {{schema}}."workflow_status" ("created_at") WHERE "status" = 'PENDING';
