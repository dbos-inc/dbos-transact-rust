-- Migration 33: Add a rate_limited column to workflow_status. Workflows
...
-- (see idx_workflow_status_rate_limited in migration 34).
--
...
ALTER TABLE {{schema}}."workflow_status" ADD COLUMN IF NOT EXISTS "rate_limited" BOOLEAN NOT NULL DEFAULT FALSE;
